...
; (gtk_accel_path "<Window>/next-image" "")
...
; (gtk_accel_path "<Window>/previous-image" "")
; (gtk_accel_path "<Window>/fullscreen" "")
...
; (gtk_accel_path "<Window>/unfullscreen" "")
; (gtk_accel_path "<Actions>/RsttoWindow/size-menu" "")
; (gtk_accel_path "<Window>/refresh" "")
